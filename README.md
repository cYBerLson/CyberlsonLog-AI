...
CyberlsonLog AI was built to OWASP Top 10 (2021) standards.
...
Health check.
```json
{"status": "ok", "service": "CyberlsonLog AI"}
```
...
*CyberlsonLog AI is an educational and defensive security tool. It contains no offensive security capabilities, exploit code, or attack automation of any kind.*
